...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $projects = [
            ...
            ['name' => 'Roze OS', 'slug' => 'roze-os', 'tagline' => 'A personal operating system experiment.', 'description' => 'A focused operating system environment built around the Roze developer ecosystem.', 'category' => 'Operating system', 'accent' => 'mint', 'icon' => 'O', 'version' => '0.3.0', 'platform' => 'Linux', 'downloads' => 289, 'notes' => 'Hardware detection and the initial installer experience.'],
