...
class MarketplaceController extends Controller
{
    public function index(Request $request)
    {
        ...
        $projects = SoftwareProject::with('ecosystemProfile')
    ...
    public function item(MarketplaceItem $item)
    {
        ...
        $item->load(['project.ecosystemProfile', 'releases' => fn ($q) => $q->where('is_published', true)->latest('published_at')->latest('id')]);
