        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selected): ?>
            ...
            <?php else: ?>
                <section id="releases" class="detail-section">
                    <div class="detail-intro"><span class="project-icon large accent-<?php echo e($selected->accent); ?>"><?php echo e($selected->icon); ?></span><div><p class="eyebrow">Selected project</p><h2><?php echo e($selected->name); ?></h2><p><?php echo e($selected->description); ?></p></div></div>
...
<?php /**PATH /home/firoze/Downloads/RozeHub-documentation-size-controls-migration-fixed/RozeHub-final/resources/views/livewire/hub.blade.php ENDPATH**/ ?>