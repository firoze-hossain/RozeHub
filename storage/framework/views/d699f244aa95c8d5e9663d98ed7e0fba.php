...
<div class="admin-page-head admin-doc-project-head">
    ...
    <div class="admin-head-actions">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->github_url): ?><a class="admin-secondary" href="<?php echo e($project->github_url); ?>" target="_blank" rel="noopener">GitHub ↗</a><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<div class="admin-doc-source-strip">
    <div><span>OPEN SOURCE PROJECT</span><strong><?php echo e($project->name); ?> documentation is connected to its source repository.</strong><p>Keep implementation changes, issues, pull requests, and contributor discussion in GitHub while RozeHub remains the public documentation and release hub.</p></div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->github_url): ?><a href="<?php echo e($project->github_url); ?>" target="_blank" rel="noopener">Open repository ↗</a><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
...
<?php echo $__env->make('admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/firoze/Downloads/RozeHub-Ecosystem-Extensions-Full-Updated/RozeHub-Ecosystem-Extensions-Updated/resources/views/admin/documentation/project.blade.php ENDPATH**/ ?>